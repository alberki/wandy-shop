<nav class="navbar navbar-expand-lg navbar-dark fixed-top shadow-sm" style="background-color:#4c1130;">
    <div class="container">

        <a class="navbar-brand" href="#"><img src="<?= base_url('assets/images/logo/logo.jpg'); ?>" alt="" width="25" class="rounded"></a>
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a href="<?= base_url('cart'); ?>" class="nav-link"><i class="fas fa-shopping-cart"></i> Cart (<strong><span class="text-warning"><?= getCart(); ?></span></strong>)</a>
                </li>
