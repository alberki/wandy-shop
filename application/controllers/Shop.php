...
class Shop extends MY_Controller
{
    ...
    public function category($category, $page = null)
    {
        ...
        $data['category'] = ucwords(str_replace('_', ' ', $category));
        $data['page'] = 'pages/home/index';
        $this->view($data);
    }
    ...
    public function search($page = null)
    {
        ...
        $data['content'] = $this->shop->select(
            [
                ...
                'category.title AS category_title', 'product.description', 'product.weight',
                'category.slug AS category_slug'
            ]
        )->join('category')->like('product.title', $keyword)->orLike('product.description', $keyword)
            ->paginate($page)
            ->get();
